...
public class GiaoDienChatRieng extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnGui.setBackground(new java.awt.Color(255, 153, 51));
        ...
        btnKetNoi.setBackground(new java.awt.Color(255, 153, 51));
    ...
    private void btnGuiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuiActionPerformed
        ...
        else
        {
            ...
            else
            {
                try {
                    dos = new DataOutputStream(form.getSocket().getOutputStream());
                    dos.writeUTF("PrivateClient!%" + nameConnect  + "!%" + form.getJLName() + "!%" + form.getJLName() + ": " + sms);
                    // ma !% là 15
                } catch (IOException ex) {
                    JOptionPane.showMessageDialog(rootPane, "Kết Nối Đến Server Bị Lỗi");
                }
